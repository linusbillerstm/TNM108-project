...
def init(df):
    ...
    try:
        ...
        # ladda TF-IDF 
        # stoppord för att filtrera bort brus
        ...
        print(f"kunde inte ladda hybrid {e}")
...
def search(query, top_k=3):
    ...
    for idx in top_indices:
        ...
        results.append({
            ...
            "reason": f"Hybrid Match ({int(score*100)}% säkerhet)",
            "score": int(score * 100)
        })
